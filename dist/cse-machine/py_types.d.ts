...
export type Instr = BaseInstr | WhileInstr | ForInstr | AssmtInstr | AppInstr | EndOfFunctionBodyInstr | ResetInstr | BranchInstr | PopInstr | EnvInstr | ArrLitInstr | UnOpInstr | BinOpInstr | BoolOpInstr;
export {};
